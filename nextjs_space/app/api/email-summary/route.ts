...
export async function POST(request: NextRequest) {
  try {
    ...
    const htmlBody = `
      <div style="font-family:Arial,sans-serif;max-width:650px;margin:0 auto;color:#1a1a2e;">
        <div style="background:#0d9488;padding:20px 24px;border-radius:8px 8px 0 0;">
          <h1 style="color:white;margin:0;font-size:22px;">💚 ${periodLabel} Wellness Summary</h1>
    ...
    const subject = `${periodLabel} Wellness Summary — ${fmtDateShort(new Date())}`;
